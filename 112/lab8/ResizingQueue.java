...
public class ResizingQueue {
   ...
   private int [] A = new int[INITIAL_SIZE];    // array to hold queue: front is always at A[0] and rear at A[next-1]
   ...
   public int dequeue() {            // remove the top integer and return it -- will cause error if empty!
      ...
      // PLEASE IMPLEMENT DEQUEUE METHOD
      // REMEMBER THAT A[0] IS ALWAYS THE FRONT OF THE QUEUE
